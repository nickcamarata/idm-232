...
--
-- Host: localhost:3306
-- Generation Time: Jun 07, 2018 at 09:12 AM
...
CREATE TABLE `directions` (
  `id` int(10) NOT NULL,
  `keyo` int(10) NOT NULL,
  `image_high-res` varchar(100) NOT NULL,
  `image_2_retina` varchar(100) NOT NULL,
  `direction` varchar(10000) NOT NULL
...
INSERT INTO `directions` (`id`, `keyo`, `image_high-res`, `image_2_retina`, `direction`) VALUES
...
(95, 17, '1218_2PV3_Broccoli-Fregola-Sarde_18467_PRINT_WEB_high_feature', '1218_2PV3_Broccoli-Fregola-Sarde_18467_PRINT_WEB_retina_feature', '2. Prepare the remaining ingredients: While the vegetables roast, quarter and deseed the lemon. Peel and finely chop the garlic; using the flat side of your knife, smash until it resembles a paste (or use a zester). Roughly chop the almonds. Using a fork, crumble the cheese into small pieces. Pick the mint leaves off the stems; discard the stems.'),
...
(171, 30, '0101_2PV2_Smoky-Kale-Mushroom-Flatberad_3151_WEB_high_feature', '0101_2PV2_Smoky-Kale-Mushroom-Flatberad_3151_WEB_retina_feature', '1. Remove the dough and honey from the refrigerator to bring to room temperature. Place an oven rack in the center of the oven, then preheat to 475°F. Wash and dry the fresh produce. Thinly slice the mushrooms. Peel and roughly chop the garlic. Peel and thinly slice the onion. Remove and discard the stems of the kale; roughly chop the leaves. Grate both cheeses on the large side of a box grater (discarding any rind). Combine in a bowl.'),
(172, 30, '0101_2PV2_Smoky-Kale-Mushroom-Flatberad_3181_WEB_high_feature', '0101_2PV2_Smoky-Kale-Mushroom-Flatberad_3181_WEB_retina_feature', '2. In a large pan (nonstick, if you have one), heat a drizzle of olive oil on medium-high until hot. Add the sliced mushrooms in an even layer. Cook, without stirring, 2 to 3 minutes, or until lightly browned. Add the chopped garlic and sliced onion; season with salt and pepper. Cook, stirring occasionally, 2 to 3 minutes, or until lightly browned and fragrant.'),
(173, 30, '0101_2PV2_Smoky-Kale-Mushroom-Flatberad_3189_WEB_high_feature', '0101_2PV2_Smoky-Kale-Mushroom-Flatberad_3189_WEB_retina_feature', '3. Add the chopped kale to the pan; season with salt and pepper. Cook, stirring frequently, 1 to 2 minutes, or until slightly wilted. Add 1/4 cup of water; season with salt and pepper. Cook, stirring occasionally, 3 to 4 minutes, or until the kale has wilted and the water has cooked off. Turn off the heat. Season with salt and pepper to taste.'),
(174, 30, '0101_2PV2_Smoky-Kale-Mushroom-Flatberad_3207_WEB_high_feature', '0101_2PV2_Smoky-Kale-Mushroom-Flatberad_3207_WEB_retina_feature', '4. Lightly oil a sheet pan. On a work surface, using your hands and a rolling pin (or a wine bottle), gently stretch and roll the dough to a 1/8-inch thickness. (If the dough is resistant, let rest for 5 minutes.) Carefully transfer the dough to the sheet pan; rub the dough into the pan to coat the bottom in oil. Leaving a 1-inch border around the edges, evenly top the prepared dough with the finished vegetables, grated cheeses, and a drizzle of olive oil. Season with salt and pepper. Bake, rotating the sheet pan halfway through, 14 to 16 minutes, or until the crust has browned and the cheese has melted. Remove from the oven and let stand for at least 2 minutes.'),
(175, 30, '0101_2PV2_Smoky-Kale-Mushroom-Flatberad_3219_WEB_high_feature', '0101_2PV2_Smoky-Kale-Mushroom-Flatberad_3219_WEB_retina_feature', '5. While the flatbread bakes, cut off and discard the root end of the endive; roughly chop the leaves. Core, quarter, and thinly slice the apple. To make the dressing, in a large bowl, whisk together the vinegar, honey (kneading the packet before opening), and 1 tablespoon of olive oil until thoroughly combined. Season with salt and pepper to taste.'),
(176, 30, '0101_2PV2_Smoky-Kale-Mushroom-Flatberad_3233_WEB_high_feature', '0101_2PV2_Smoky-Kale-Mushroom-Flatberad_3233_WEB_retina_feature', '6. Just before serving, add the chopped endive and sliced apple to the bowl of dressing. Toss to combine; season with salt and pepper to taste. Serve the baked flatbread with the salad on the side. Enjoy!'),
...
(189, 33, '0108_2PV2_Stir-Fry-Egg_0175_WEB_high_feature', '0108_2PV2_Stir-Fry-Egg_0175_WEB_retina_feature', '1. Prepare the ingredients & marinate the radish: Wash and dry the fresh produce. Peel the carrots; thinly slice on an angle. Slice the celery on an angle into 1/2-inch-thick pieces. Halve the orange; squeeze the juice into a medium bowl, straining out any seeds. Peel and roughly chop the garlic. Peel and finely chop the ginger. Cut off and discard the root end of the bok choy; roughly chop. Quarter and deseed the lemon. Cut off and discard the ends of the radishes; small dice. Place in a bowl and top with the juice of 1 lemon wedge and half the sesame oil. Season with salt and pepper. Set aside to marinate, stirring occasionally, for at least 10 minutes. Season with salt and pepper to taste.'),
(190, 33, '0108_2PV2_Sweet-Sour-Stir-Fry_97727_WEB_high_feature', '0108_2PV2_Sweet-Sour-Stir-Fry_97727_WEB_retina_feature', '2. While the radishes marinate, in a medium saucepan, combine the rice, a big pinch of salt, and 1 1/2 cups of water; heat to boiling on high. Once boiling, cover and reduce the heat to low. Cook 12 to 14 minutes, or until the water has been absorbed and the rice is tender. Turn off the heat and fluff with a fork. Cover to keep warm.'),
(191, 33, '0108_2PV2_Sweet-Sour-Stir-Fry_97749_WEB_high_feature', '0108_2PV2_Sweet-Sour-Stir-Fry_97749_WEB_retina_feature', '3. Start the stir-fry: While the rice cooks, in a large pan (nonstick, if you have one), heat 2 teaspoons of olive oil on medium-high until hot. Add the sliced carrots and celery; season with salt and pepper. Cook, stirring occasionally, 6 to 7 minutes, or until slightly softened.'),
(192, 33, '0108_2PV2_Sweet-Sour-Stir-Fry_97760_WEB_high_feature', '0108_2PV2_Sweet-Sour-Stir-Fry_97760_WEB_retina_feature', '4. While the vegetables cook, to the bowl of orange juice, add the soy glaze, soy marinade, and the juice of the remaining lemon wedges. Stir to combine; season with salt and pepper to taste.'),
...
INSERT INTO `ingredients` (`id`, `keyo`, `ingredients`) VALUES
...
CREATE TABLE `main` (
  ...
  `ingredients_img` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(23, 'Roasted Squash Curry', 'with Crispy Mung Beans & Jasmine Rice', 'In this recipe, veggie curry gets a unique lift from spaghetti squash—oven-roasted, then broken into pasta-like strands with a fork. We?re finishing our squash and bok choy in a sauce made with fresh aromatics and two well-balanced pantry ingredients: spicy yellow curry paste and cooling coconut milk. A garnish of dried mung beans brings it all together with exciting crunch.', 'Beauty_20-_20Yellow_20Curry_20Paste_20-_209700_thumb', 'ING_11-27_2PV3_large_feature'),
...
INSERT INTO `tags` (`id`, `keyo`, `tag`) VALUES
(1, 1, 'easy'),
(2, 1, 'full of flavor'),
(3, 1, 'fruit'),
(4, 2, 'comfort food'),
...
--
ALTER TABLE `tags`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;COMMIT;
